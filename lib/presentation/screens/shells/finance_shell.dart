  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (isDesktop) {
      return Scaffold(
        body: Row(
          children: [
            // Left Desktop Navigation Sidebar for Finance
            Container(
              width: 250,
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          onTap: (index) {
            ref.read(financeNavigationProvider.notifier).setIndex(index);
          },
          ...
          items: const [
            ...
            BottomNavigationBarItem(
              icon: Padding(
                padding: EdgeInsets.only(bottom: 4),
                child: Icon(Icons.badge_outlined, size: 22),
              ),
              activeIcon: Padding(
                padding: EdgeInsets.only(bottom: 4),
                child: Icon(Icons.badge, size: 22),
              ),
              label: 'HR',
            ),
            BottomNavigationBarItem(
              icon: Padding(
                padding: EdgeInsets.only(bottom: 4),
                child: Icon(Icons.business_outlined, size: 22),
              ),
              activeIcon: Padding(
                padding: EdgeInsets.only(bottom: 4),
                child: Icon(Icons.business, size: 22),
              ),
              label: 'VENDORS',
            ),
          ],
