...
class _CalendarScreenState extends ConsumerState<CalendarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedNepali = _selectedDate.toNepaliDateTime();
    ...
    final monthEvents = eventsAsync.maybeWhen(
      data: (events) => events.where((e) {
        final np = e.date.toNepaliDateTime();
    ...
    final monthOrders = ordersAsync.maybeWhen(
      data: (orders) => orders.where((o) {
        final np = o.eventDate.toNepaliDateTime();
        return np.year == selectedNepali.year &&
            np.month == selectedNepali.month &&
    ...
    final dayEvents = monthEvents
        .where((e) => e.date.toNepaliDateTime().day == selectedNepaliDay)
        .toList();
    final dayOrders = ordersWithoutEvent
        .where((o) => o.eventDate.toNepaliDateTime().day == selectedNepaliDay)
        .toList();
