                  ...
                  child: filteredStaff.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final activeLeave = leaveRequests.where(
                              (l) =>
                                  l.staffId == staff.id &&
                            ...
                            final hasLeaveConflict = activeLeave != null;

                            // Check Double-Booking Conflict
                            final conflictingOrder = allOrders.where(
                              (o) =>
                                  o.id != widget.orderId &&
                            ...
                            final hasOrderConflict = conflictingOrder != null;
